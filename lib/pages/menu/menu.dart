                    ...
                    child: Column(
                      children: [
                        ListTile(
                          ...
                          subtitle: Text("RM${int.parse(menuProvider.menuList[index].price ?? '0.00').toStringAsFixed(2)}"),
                        ),
                              ...
                              return Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    const SizedBox(height: 5),
                                    Text("RM${double.parse(menuProvider.menuList[index].price ?? '0.00').toStringAsFixed(2)}",                               
                                        style: const TextStyle(
                                            fontSize: 16,
                                                  ...
                                                  await DatabaseService(
                                                      ...
                                                      .addToCart(
                                                          ...
                                                          menuProvider
                                                                  ...
                                                                  .img ??
                                                              '',
                                                          double.tryParse(menuProvider.menuList[index].price ?? '0.00') ?? 0.00);
                                                }),
                                          ),
                                        ],
                                      ),
                                                           ...
                                                           context.showOverlayLoader(
                                                              ...
                                                              asyncFunction:
                                                                  ...
                                                                  await Provider.of<MenuProvider>(context, listen: false)
                                                                    .menuDelete(id: menuProvider.menuList[index].id);
                                                              },
                                                            );
