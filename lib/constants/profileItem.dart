...
class ProfileItem extends StatelessWidget {
  ...
  ProfileItem({ required this.value, required this.controller, required this.enable});
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(
            color: enable ? Color(0xFF303030): Color(0xFFE0E0E0), // Border color
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(color: Color(0xFF3C312B).withOpacity(0.1), width: 2.0)
                    ),
